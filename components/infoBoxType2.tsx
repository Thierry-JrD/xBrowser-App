...
export default function InfoBoxType2({ color }: { color: string }) {
  return (
    <View style={styles.container}>
        <View style={{ width: '100%', height: 1, backgroundColor: color, marginBottom: 3 }}></View>
        <View style={{  flex: 1, gap: 10, width: '100%', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', padding: 10 }}>
            <View style={[styles.imageContainer, { borderColor: color }]}>
                ...
                <Image source={require('@/assets/images/android-icon-foreground.png')} style={styles.image} />
